...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InvoiceItem.currency'
        db.add_column('shoppingcart_invoiceitem', 'currency',
                      self.gf('django.db.models.fields.CharField')(default='usd', max_length=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InvoiceItem.currency'
        db.delete_column('shoppingcart_invoiceitem', 'currency')
